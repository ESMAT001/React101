...
function Modal({ closeModal, src, alt,downloadLink }) {
    ...
    return (
        <div className={modalCls} onClick={closeModal}>
            <div className="w-9/12 mx-auto ">
                <a className="absolute top-10 right-10 bg-purple-600 text-white font-bold px-2 py-2" href={downloadLink} download target="_blank" rel="noreferrer"
                >Download</a>
                <img
